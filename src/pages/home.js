...
export async function getStaticProps() {
    ...
    const url2 = `https://newsapi.org/v2/everything?q=economy&from=11/20/2022&sortBy=popularity&pageSize=26&language=pt&apiKey=a242db57c2014e789589154d5e3bd158`;
